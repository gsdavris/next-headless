      ...
      { hasNextPage ? (
        <div className="w-full flex justify-center lg:my-10">
          { loading ? (
            ...
            <button
              className="flex items-center cursor-pointer	bg-indigo-600 hover:bg-indigo-700 text-white transition-colors duration-500 border border-gray-500 px-4 py-3"
